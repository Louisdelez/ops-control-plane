...
Le lecteur de journaux v2 corrige les blocages sur grandes lignes et conserve des signalements explicites pour les entrées non archivables. Il est actif sur le poste de contrôle ; son activation distante attend les accords correspondants. Les états des conteneurs retirés sont conservés sans les compter comme des sources actives en panne.
